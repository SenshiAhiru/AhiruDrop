          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="flex items-center justify-center h-10 w-10 rounded-lg bg-surface-800 text-surface-400 hover:bg-primary-600 hover:text-white transition-all duration-200"
