        ...
        >
          <div className="flex items-start gap-3 p-4">
            ...
            <button
              ...
              className="-m-1.5 flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md opacity-70 hover:opacity-100 transition-opacity"
...
export { ToastProvider, ToastContainer, useToast, type ToastType, type Toast };
