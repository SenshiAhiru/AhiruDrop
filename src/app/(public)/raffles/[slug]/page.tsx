        ...
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="flex flex-col items-center">
              ...
              {raffle.skinMarketPrice != null && raffle.skinMarketPrice > 0 && (
                <div className="mt-4 flex items-center gap-2 text-sm text-[var(--muted-foreground)]">
                  ...
                  Preco de mercado: {formatCurrency(raffle.skinMarketPrice)}
                </div>
              )}
            </div>
            ...
            <div className="space-y-6">
              ...
              {/* Price */}
              <div className="rounded-xl border border-primary-600/30 bg-primary-600/5 p-5">
                <p className="text-sm text-[var(--muted-foreground)]">Preco por cota</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm text-[var(--muted-foreground)]">
                  ...
                  <span>{raffle.stats.available} disponiveis</span>
                </div>
              </div>
              ...
              {raffle.description && (
                <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-5">
                  <h3 className="text-sm font-semibold text-[var(--foreground)] mb-2">Descricao</h3>
