...
export const en: Record<MessageKey, string> = {
  ...
  "meta.home.ogTitle": "AhiruDrop — CS2 Skin Raffles",
  "meta.home.ogDescription": "Join CS2 skin raffles with draws publicly verifiable via Bitcoin.",
  "meta.home.twitterDescription": "CS2 skin raffles with provably fair draws. Transparent, fair and verifiable.",
  "meta.about.title": "How It Works",
  "meta.about.description": "Understand how raffles work on AhiruDrop: from buying a ticket to the provably fair draw via Bitcoin.",
  "meta.contact.title": "Contact & Support",
  "meta.contact.description": "Get in touch with AhiruDrop support. We reply within 24 business hours.",
  "meta.faq.title": "FAQ",
  "meta.faq.description": "Answers to the most common questions about raffles, draws, AhiruCoins and skin delivery.",
  "meta.raffles.title": "CS2 Skin Raffles",
  "meta.raffles.description": "Browse every available Counter-Strike 2 skin raffle. Rifles, knives, gloves and more with provably fair draws.",
  "meta.raffles.ogTitle": "CS2 Skin Raffles — AhiruDrop",
  "meta.raffles.ogDescription": "Join CS2 skin raffles with verifiable draws.",
  "meta.winners.title": "Winners Hall",
  "meta.winners.description": "See every draw held on AhiruDrop. Each one with public proof of integrity via Bitcoin.",
  "meta.winners.ogTitle": "Winners Hall — AhiruDrop",
  "meta.winners.ogDescription": "Transparent history of every draw held.",
  "meta.raffle.notFoundTitle": "Raffle not found",
  "meta.raffle.notFoundDesc": "The raffle you're looking for doesn't exist or was removed.",
  "meta.raffle.statusAvailable": "Available",
  "meta.raffle.statusWaiting": "Awaiting draw",
  "meta.raffle.statusDrawn": "Drawn",
  "meta.raffle.titleSuffix": "Raffle for {price} AHC",
  "meta.raffle.descNumbers": "{total} tickets",
  "meta.raffle.descPerTicket": "{price} AHC per ticket",
  "meta.raffle.descProvablyFair": "Provably fair draw via Bitcoin.",
  "meta.raffle.fallbackTitle": "Raffle",
  "meta.raffle.fallbackDesc": "Join CS2 skin raffles on AhiruDrop",
  "meta.verify.defaultTitle": "Provably Fair Verification",
  "meta.verify.title": "Draw proof — {title}",
  "meta.verify.description": "Publicly verify the draw of raffle \"{title}\" using the Bitcoin block hash.",
  "meta.verify.ogTitle": "Provably Fair: {title}",
  "meta.verify.ogDescription": "Publicly verifiable draw with Bitcoin + HMAC-SHA256",
  "meta.og.perNumber": "Per ticket",
  "meta.og.numbersSuffix": "tickets",
